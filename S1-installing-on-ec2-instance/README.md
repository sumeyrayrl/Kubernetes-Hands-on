...
```bash
sudo kubeadm init --apiserver-advertise-address=172.31.21.74 --pod-network-cidr=10.244.0.0/16
```
...
>```bash
>sudo kubeadm init --apiserver-advertise-address=172.31.76.130 --pod-network-cidr=10.244.0.0/16 --ignore-preflight-errors=NumCPU
>```
